...
public class FloodFill {
    ...
    public void test(){
        ...
        ShowUtil.showIntMatrix(floodFill(new int[][]{{0,0,0},{0,0,0}},0,0,2));

    }

    int[][] vectorArray=new int[][]{{0,1},{1,0},{0,-1},{-1,0}};
    ...
    public int[][] dfs(int[][] image,int sr,int sc,int newColor,int oldColor){
        ...
        for(int[] vector:vectorArray){
            dfs(image,sr+vector[0],sc+vector[1],newColor,oldColor);
        }
        return image;
    }
}
